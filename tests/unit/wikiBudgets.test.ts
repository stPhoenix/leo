...
describe('WIKI_BUDGETS', () => {
  it('exports the token caps from NFR-WIKI-10 with the spec values', () => {
  ...
  it('is frozen-ish via `as const` (TypeScript) — runtime sanity: Object.keys has 10 entries', () => {
    expect(Object.keys(WIKI_BUDGETS).length).toBe(10);
  });
